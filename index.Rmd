...
```
Combined Sentinel-1 and Sentinel 2 data to assess damage in Turkey-Syria Earthquake
...
```
dNBR image of portugal wildfires
...
```
Sentinel-2 Imagery from a flood in Nigeria. Cloud shadows, like in this image, are sometimes confused for water by water detection algorithms.
